...
from app.api.routes import health, audio, tasks, organizations, sessions, system_prompts, global_prompt, projects, profile, tickets
import logging
...
app.include_router(global_prompt.router)
